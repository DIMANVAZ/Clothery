export const About = {
   ...
   `<div class="About-whole-container">
        ...
        Успешно выполнив его, в 1933 году он даёт мастерской название <b><i>Clothery</i></b> (по аналогии с привычными англичанам 
        ...
        дочерний филиал, который в дальнейшем выделится в отдельный бренд,  сменит хозяина и станет известен как <b><i>Aeronautica Militare</i></b>.    

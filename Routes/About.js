export const About = {
   ...
   `<div class="About-whole-container">
        ...
        появление коллекции от Маринони на Неделе Моды в Лондоне в 1940 году.<br/>
        Начало Второй Мировой войны могло бы вновь вернуть бренд к "военным истокам", но
        Маринони решает не оставлять гражданскую моду, ибо войны рано или поздно заканчиваются.
        Тем не менее, заработав себе имя именно как армейский поставщик, он создаёт для потребностей армии
        дочерний филиал, который в дальнейшем выделится в отдельный бренд,  сменит хозяина и станет известен как Aeronautica Militare.
